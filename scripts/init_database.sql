...
===================================================================
Script Purpose:
  This script created a new database named 'DataWarehouse' after checking if it already exists  
  If the database exits, it is dropped and recreated. Additionally, the script sets up three schemas withing the database: 'bronze', 'silver', and 'gold'.
