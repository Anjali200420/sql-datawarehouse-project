...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Bulk Insert in cust_info table
        ...
        -- Bulk Insert in sales_details table
        SET @start_time = GETDATE();
        ...
        -- Bulk Insert in cust_az12 table
        SET @start_time = GETDATE();
        ...
        -- Bulk Insert in px_cat_g1v2 table
        SET @start_time = GETDATE();
